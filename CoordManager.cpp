...
QList<QVector3D> CoordManager::processCoordinates(const QStringList& iso_files, bool sculpture, bool fit, bool size_given)
{
    ...
    */
    ...
    iso = Helpers::getFilesContentAsVector(iso_files);
    ...
    */
    ...
    QProgressDialog progress_dialog = QProgressDialog(tr("extract_coords"), tr("cancel"), 0, num_rows - 1);
    ...
    */
    ...
    if (this->offset_x > 0 || this->offset_y > 0)
    {
        ...
        // Translate the coordinates contained into the list of the points at max depth
